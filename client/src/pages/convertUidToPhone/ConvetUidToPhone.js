...
const AlertDescription = () => {
  return (
    <>
      <p>
        - Convert UID là công cụ giúp chuyển đổi từ UID Facebook sang số điện
        thoại để chạy tệp quảng cáo hoặc để dùng trong các chiển dịch marketing
        như: Telesale, zalo, sms...
      </p>
      <p>- Mỗi UID convert thành công sẽ bị trừ 1 Point.</p>
...
const ScanUidPhone = () => {
  ...
  function handleConvertFileButton() {
    ...
    agent
      .post("/convert/file-uids-to-phone", {
